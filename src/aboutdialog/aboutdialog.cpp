    ...
    : QDialog{parent}
{
    ...
    headerBox->setDescription(tr("Easy-to-use application for viewing and editing tabular files."));
    headerBox->setIcon(QIcon::fromTheme("comma-qt"_L1, QIcon(":/icons/apps/16/comma-qt"_L1)));
